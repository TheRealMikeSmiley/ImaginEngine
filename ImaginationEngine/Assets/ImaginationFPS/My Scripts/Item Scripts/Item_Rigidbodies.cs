...
/*
 * 
 * For setting rigidbody to true or false depending on whether the item is held, or thrown by the player
 * 
 * 
 */
...
namespace ImaginationEngine {
	public class Item_Rigidbodies : MonoBehaviour {
		...
		//Automatically set to true if already in the inventory
