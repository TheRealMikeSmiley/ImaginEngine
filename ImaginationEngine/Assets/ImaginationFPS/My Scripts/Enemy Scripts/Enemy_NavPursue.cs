...
using UnityEngine;
using UnityEngine.AI; //use the artificial intelligence modules already available in Unity
...
namespace ImaginationEngine {
	public class Enemy_NavPursue : MonoBehaviour {
		...
		void DisableThis() {
			...
			this.enabled = false; //ensures update method doesnt continue to run
		}
	}
}
